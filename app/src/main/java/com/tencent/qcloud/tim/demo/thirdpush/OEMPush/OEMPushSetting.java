...
public class OEMPushSetting implements PushSettingInterface {
    ...
    public void init() {
        Context context = DemoApplication.Companion.getMApplication();
        ...
        if (BrandUtil.isBrandXiaoMi()) {
            ...
            // vivo离线推送
            PushClient.getInstance(DemoApplication.Companion.getMApplication()).initialize();
    ...
    private void prepareOEMPushToken() {
        ...
        final Context context = DemoApplication.Companion.getMApplication();
